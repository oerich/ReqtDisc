...
\viss\  is an interactive tool that allows software developers and managers to dynamically explore the discussion of requirements  in online repositories with a focus on highlighting the difference between clarification and implementation related communication (Sources: \url{https: //github.com/oerich/ReqtDisc}). %Available data sources include the webservice of IBM Jazz and the RSS feed of Atlassian Jira.
%Data sources for other issue trackers can be easily added.
...
\begin{figure}[b]
\centering
\includegraphics[width=0.627\columnwidth]{img/example-trajectory}
\caption{Example of a requirement discussion's clarification trajectory}
