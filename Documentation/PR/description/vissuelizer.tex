...
\viss\  is an interactive tool that allows software developers and managers to dynamically explore the discussion of requirements  in online repositories with a focus on highlighting the difference between clarification and implementation related communication (Sources: \url{https: //github.com/oerich/ReqtDisc}). Available datasources include the webservice of IBM Jazz as well as the RSS feed of Atlassian Jira and it is possible to add datasources for other issue trackers.
