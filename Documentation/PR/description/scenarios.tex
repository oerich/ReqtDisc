...
\end{enumerate}
\begin{figure}
\missingfigure[figwidth=\columnwidth]{Some nice trajectory, e.g. the visual studio one.}
...
\begin{figure}
\missingfigure[figwidth=\columnwidth]{Some nice social network for the trajectory above}
...
\begin{figure}
\missingfigure[figwidth=\columnwidth]{Some nice social network for a set of issues}
